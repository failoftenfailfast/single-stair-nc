      ...
      <div className="container-custom">
        ...
        >
          ...
          >
            READY TO MAKE A
            <br />
            <span className="border-b-4 border-white">DIFFERENCE?</span>
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              <div className="w-16 h-16 border-2 border-white group-hover:border-black flex items-center justify-center mx-auto mb-6">
